...
import com.onlinepayments.defaultimpl.DefaultConnectionTest;
...
public class FactoryTest {
	...
	public void testCreateConfiguration() {
		...
		Assert.assertEquals(URI.create("https://payment.preprod.online-payments.com"), configuration.getApiEndpoint());
