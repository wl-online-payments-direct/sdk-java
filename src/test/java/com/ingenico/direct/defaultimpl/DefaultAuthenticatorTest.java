...
public class DefaultAuthenticatorTest {
	...
	public void testToDataToSign() {
		...
		String dataToSign = authenticator.toDataToSign("POST", URI.create("http://localhost:8080/v2/1/services%20bla/convert/amount?aap=noot&mies=geen%20noot"), httpHeaders);
		...
		String expectedEnd =
			...
			"/v2/1/services%20bla/convert/amount?aap=noot&mies=geen noot\n"
		;
