...
import com.ingenico.direct.defaultimpl.DefaultConnectionTest;
...
public class FactoryTest {
	...
	public void testCreateConfiguration() {
		...
		Assert.assertEquals(URI.create("https://payment.preprod.direct.ingenico.com"), configuration.getApiEndpoint());
	...
	public void testCreateCommunicator() {
		...
		Assert.assertSame(DefaultCommunicator.class, communicator.getClass());
		...
		MetaDataProvider metaDataProvider = communicator.getMetaDataProvider();
