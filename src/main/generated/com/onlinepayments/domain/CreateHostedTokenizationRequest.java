...
public class CreateHostedTokenizationRequest {
    ...
    private Boolean askConsumerConsent;

    private CreditCardSpecificInputHostedTokenization creditCardSpecificInput;

    private String locale;

    private PaymentProductFiltersHostedTokenization paymentProductFilters;
