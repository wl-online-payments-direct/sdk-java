 ...
 */
public interface HostedFieldsClientInterface {

    /**
     * Resource /v2/{merchantId}/hostedfields/sessions - Create hosted fields session
     *
     * @param body CreateHostedFieldsSessionRequest
     ...
     */
    CreateHostedFieldsSessionResponse createHostedFieldsSession(CreateHostedFieldsSessionRequest body);
     ...
     * @throws ApiException if the payment platform returned any other error
     */
    CreateHostedFieldsSessionResponse createHostedFieldsSession(CreateHostedFieldsSessionRequest body, CallContext context);
     ...
     * @throws ProblemDetailsException if the payment platform returned a problem details error response
     * @throws ValidationException if the request was not correct and couldn't be processed (HTTP status code 400)
     * @throws AuthorizationException if the request was not allowed (HTTP status code 403)
     * @throws ReferenceException if an object was attempted to be referenced that doesn't exist or has been removed,
     *            or there was a conflict (HTTP status code 404, 409 or 410)
     ...
     * @throws ApiException if the payment platform returned any other error
     */
    GetHostedFieldsSessionResponse getHostedFieldsSession(String sessionId);
     ...
     * @throws ApiException if the payment platform returned any other error
     */
    GetHostedFieldsSessionResponse getHostedFieldsSession(String sessionId, CallContext context);
}
