 ...
 */
public interface CofSeriesClientInterface {

    /**
     * Resource /v2/{merchantId}/tokens/importCofSeries - Imports the COF Series token.
     *
     * @param body ImportCofSeriesRequest
     ...
     */
    ImportCofSeriesResponse importCofSeries(ImportCofSeriesRequest body);
     ...
     * @throws ApiException if the payment platform returned any other error
     */
    ImportCofSeriesResponse importCofSeries(ImportCofSeriesRequest body, CallContext context);
}
