...
public interface MerchantBatchClientInterface {
     ...
     *
     * @param merchantBatchReference String
     * @param query GetPaymentsReportParams
     ...
     * @throws ApiException if the payment platform returned any other error
     */
    PaymentsReportResponse getPaymentsReport(String merchantBatchReference, GetPaymentsReportParams query);
     ...
     * @throws ApiException if the payment platform returned any other error
     */
    PaymentsReportResponse getPaymentsReport(String merchantBatchReference, GetPaymentsReportParams query, CallContext context);
}
